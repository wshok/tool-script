...
url='https://oapi.dingtalk.com/robot/send?access_token=0bc0e6c67ed1ea6207cbd65eff058278568c1889c5f7361fb918367d3a703476'
if [ -f $source_log ];then
    ...
    if [ $err_num -ge 10 ];then 
        ...
        curl -s -o /dev/null -d '{"msgtype":"text","text":{"content":"warning：IGGM \u8bbf\u95ee\u5f02\u5e38 \r\n '"$err_lines"' "}}' $url -H 'Content-Type: application/json'
    fi
fi
